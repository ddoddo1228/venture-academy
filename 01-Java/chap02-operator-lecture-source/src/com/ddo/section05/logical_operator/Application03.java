package com.ddo.section05.logical_operator;
...
public class Application03 {
    public static void main(String[] args) {
        ...
        * 따라서 연산 횟수를 줄이기 위해서는 &&연산의 경우 false가 나올 가능성이 높은 조건을 작성하는 편이 좋다.
        * */

        int num1 = 10;

        /* 앞의 조건이 false 로 강제화 해 두고 && 뒤의 조건은 선치 증가로 값을 증가시킨 후 별 의미 없는 조건으로 만들어 놓았다.
        ...
        * */
        ...
        /* 앞에 조건을 true로 강제화 해 두고 || 뒤의 조건은 선치 증가로 값을 증가시킨 후 별 의미 없는 조건식으로 만들어 놓닸다.
        * num1 선치 증가 코드가 동작했다면 rsult2 는 11일 것이고, 동작하지 않았다면 결과는 10일 것이다.
        * */
