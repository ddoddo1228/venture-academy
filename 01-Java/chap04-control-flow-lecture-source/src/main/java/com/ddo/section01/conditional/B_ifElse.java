package com.ddo.section01.conditional;
...
public class B_ifElse {
    ...
    public void testSimpleIfElseStatement() {
        ...
        /* 조건을 만족하는지 여부에 따라 둘 중 하나는 무조건 실해해야 하는 경우 많이 사용한다. */
        ...
        int num = sc.nextInt();
        /* 조건문은 반드시 true 혹은 false가 나오도록 작성해야 한다. */
        /* 짝수인지 조건 확인 */
        if (num % 2 != 0) {
    ...
    public void testNestedIfElseStatement() {
        ...
        /* if-else 문 안에서 또 다른 조건을 사용해서 if-else 문을 사용할 수 있다. */
