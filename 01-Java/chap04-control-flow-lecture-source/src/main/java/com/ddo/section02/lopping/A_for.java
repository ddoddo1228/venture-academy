...
public class A_for {
    public void testSimpleForStatement() {
        /* for문 단독 사용에 대한 흐름을 이해하고 적용 할 수 있다. */
        /* [for문 표현식]
         * for(초기식; 조건식; 증감식){
         *       조건을 만족할 경우 수행 할 구문(반복 할 구문);
         * }
         * */

        /* 1 부터 10 까지 1씩 증가시키면서 (10번) i값을 출력하는 기본 반복문 */
        for (int i = 1; i <= 10; i++) {
    ...
    public void testForExample1(){
         ...
         * 3. 저장된 이름을 출력
         *
         * 반복 횟수는 1부터 10까지 1씩 증가하여 총 10번을 반복한다. */
        ...
        System.out.println("10명의 학생들을 입력 받고 출력하는 기능을 완료했습니다.");
    ...
    public void testForExample2(){
        ...
        * */
        ...
        /* 이렇게만 적상되어 있으면 처음 프로그래밍 하는 사람에게는 꽤나 난감하다.
        * 어느 정도 익숙한 사람에게는 저 문자에서 해결해야 하는 내용과 규칙이 머릿속에 자연스럽게 그려지지만
        * 처음 접하는 사람한테는 그렇지 않다.
        * 단계적으로 접근할 수 있도록 위의 내용을 좀 줄여서 다시 작성해본다면
        * 1부터 10까지 1씩 증가시키면서 값을 저장할 변수에 계속 누적시켜 변수에 저장한 값을 출력하세요가 된다.
        * */
    ...
    public void testForExample3 (){
        ...
        /* 반복문을 꼭 써야하는 경우들도 종종 있다.
        * 우선 반복문을 써야하는 필요성을 느끼기 위해 반복문을 쓰지 않고 작성해보자
        * */
        /* 5~10 사이의 난수를 발생시켜서
    ...
    public void printSimpleGugudan() {
         ...
         * */
        /* 구구단은 곱하는 수가 1부터 시작해서 9까지 1씩 증가하여 곱하는 규칙을 가지고 있다.
