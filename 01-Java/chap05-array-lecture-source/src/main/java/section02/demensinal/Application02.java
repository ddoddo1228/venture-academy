...
public class Application02 {
    public static void main(String[] args) {
        /* 2차원 정변 배열을 선언 및 할당하여 사용 할 수 있다. */

        /* 1, 배열의 선언 및 할당 */
        /* 정변 배열의 경우 각 인덱스 별로 배열을 따로 할당 할 수 도 있지만 선언과 동시에 모든 배열을 할당 할 수 있다. */
        /* 자료형 [][] 변수명 = new 자료형[할당할 배열의 갯수][할당할 배열의 길이] */

        int [][] iarr = new int[3][5];

        /* 2. 각 배열의 인덱스에 접근해서 값 대입 후 출력 */
        /* 2-1 각 인덱스 공간에 하나씩 접근하여 값 대입후 출력 */
        /* 값 대입 */
        iarr[0][0] = 1;
        iarr[0][1] = 2;
        iarr[0][2] = 3;
        ...
        System.out.println();
        /* 그냥 변수 15개를 사용하는 것과 똑같다고 보면된다.
         * 하지만 배열은 []기호 안에 있는 숫자 대신 변수를 사용 할 수 있다.
         * 따라서 반복문 사용이 가능해진다
         * 위에서 값을 대입하고 출력한것에 규칙을 찾아보고 그 규칙대로 반복문을 이용해서 값을 대입 후 출력하는 구문으로 바꿔보자 */

        /* 2-2 반복문을 이용하여 값 대입 후 출력 */
        /* 배열 인덱스를 하나씩 증가시키며 0번째 인덱스부터 마지막 번째 인덱스까지 차례대로 인덱스를 증가 시키며 공간에 접근함.
         * 접근한뒤 1부터 1씩 증가하는 값을 이용해서 차례대로 대입하고,
         * 모든 인데긋에 값을 다 대입하면 다음 배열의 0번 인덱스부터 다시 접근을 시작하여
         * 배열 갯수만큼 반복적으로 접하며 값을 대입한다. */

        /* 배열에 저장하기 위한 하나씩 증가하는 값을 저장할 변수 */
        int value = 1;

        /* 배열의 갯수 만큼 반복적으로 접근하기 위한 반복문 */
        for(int i=0; i<iarr.length;i++){
            /* 하나의 배열의 0번째 부터 마지막 인덱스까지 차례대로 접근해서 값을 대입하는 용도의 반복문 */
         ...
         * 매 배열의 값을 다 출력할때 마다 한줄씩 라인을 바꿔주는 행위를 배열의 갯수만큼 반복하고있다.*/
