...
public class Application01 {
    public static void main(String[] args) {
         ...
         * 회원 정보를 관리하기 위해 회원의 여러 정보(아이디, 이름, 나이, 성별, 취미)를 취급하여 관리하려고 한다.
