...
public class Application {
    ...
    public static void main(String[] args) {
         ...
         *  부모가 가지고 있는 재산(자바에서는 클래스가 가지는 멤버)을 자식이 불려받는 의미이다.
         ...
         *   1-1. 재사용시 생산성을 크게 향상시킬 수 있다. (새롭게 작성하는거보다 빠르다)
         ...
         *  객체지향 프로그램이다.
         *
         *  적절한 책임을 수행하는 객체 또한 그객체만 수행할 수 있는 기능이라기 보다 역할의 관점으로 바라봐야 한다.
         ...
         *  상속은 자식이 부모 멤버에 접근해서 자신것처럼 사용 가능하지만, 반대의 경우는 허용되지 않는다.
         * */
