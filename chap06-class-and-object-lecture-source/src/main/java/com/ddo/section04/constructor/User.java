...
public class User {
    ...
    * 통상적으로 필드 선언부와 메소드 서언부 사이에 작성하는 것이 관례이다.
    * */

    /* 생성자의 사용 목적
    * 1. 인스턴스 생성 시점에 수행할 명령이 ㅏ있는 경우 사용한다.
    ...
    *       this.필드명 = 매개변수;        // 설정자(Setter)여러개의 기능을 한 번의 호출로 수행
    * }
    * */
    ...
    * */
    ...
    public User(){
        ...
        * */
        System.out.println("User 클래스의 기본 생성자 호출형... ");
    }

    /* 주의사항. 동일한 이름의 생성자 혹은 메소드를 한 클래스 안에서 작성하는 것은 불가능하다. (Compile name) */
//    public User(){
//        /* 2. 매개변수가 있는 생성자 */
    /* 초기화할 필드가 여러개인 경우, 초기화하고 싶은 필드의 개수별로 생성자를 여러개 준비해둘 수 있따.
    * id, pwe, name의 초기화를 담당할 생성자 */
    ...
    public User (String id, String pwd, String name){
        ...
        * 오버로딩 부분은 뒤에 변도의 챕터에서 다시 다루고 우선 지금은 매개변수 있는 생성자의 역할에 대해 살펴보자. */
...
//        this.enrollDate=otherUser.enrollDate;
        ...
        /* 4-2. 기존제 작성된 생성자를 호출하여 초기화(this())사용*/
