...
import com.ddo.section04.constructor.User;
...
public class Application {
    public static void main(String[] args) {
        ...
        *       예) 아이디, 비번, 이름이 모두 ohgiraffers인 경우
        *           new User("ohgiraffers","ohgiraffers","ohgiraffers"); 몇 번째 인자가 아이디인지 알 수 없다.
        * 2. 설정자를 이용한 초기화
        * 장점 : 필드를 초기화하는 각각의 값들이 어떤 필드를 초기화하는지 명확하게 볼 수 없다.
        *       예) 아이디, 비번, 이름이 모두 ohgiraffers인 경우
        *           User. user = newUser();
        *           user.setId("ohgiraffers");
        *           user.setPwd("ohgiraffers");
        *           user.setName("ohgiraffers");
        *           호출하는 코드만 봐도 어떤 갑시 어떤 필드를 초기화하는 내용인지 쉽게 알 수 있다.
