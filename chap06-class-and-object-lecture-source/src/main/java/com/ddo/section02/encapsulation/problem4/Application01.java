package com.ddo.section02.encapsulation.problem4;

public class Application01 {
    public static void main(String[] args) {
        /* 접근 제한자에 대해 이해하고 직접 필드에 접근하지 못하게 강제화 할 수 있다.
        * Monster 클래스의 필드를 private 만들고 객체를 생성한 뒤 직접 접근하면 compile error를 발생시킨다.
...
//        monster1.hp = 200;
        ...
        * */
        ...
        /* 캡슐화는 유지보수성 증가시키기 위해 필드의 직접 접근을 제한하고
