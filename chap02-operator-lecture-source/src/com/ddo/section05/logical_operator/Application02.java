...
public class Application02 {
    public static void main(String[] args) {
        ...
        * && : 11순위
        * || : 12순위
        * 논리 and 연산자 우선순위가 논리 or 연산자 우선순윋보다 높다. */
        ...
        /* 1. 1부터 100사이의 값인지 확인 */
        /* 1<= 변수 <= 이렇게는 사용 못함 --> 변수 >= 1 && 변수 <=100 이렇게 사용해야 한다. */
        int num1 = 55;
        ...
        /* 4. 영문자인지 확인 */
        /* A: 65, Z: 90, z:122 (중간에 91~96까지는 영문자가 아님) */
        /* 하지만 연산자 우선 순위를 디테일하게 학습하고 개발하는 개발자가 적은 현실로 인해
