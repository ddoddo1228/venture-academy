package com.ddo.section02.variable;

public class Application01 {
    public static void main(String[] args) {
        /* 변수의 사용 목적 */
        /* 1. 값의 의미를 부여하기 위한 목적 (의미 전달이 쉬워야 코드를 읽기 쉬워지고, 협업 및 유지보수에 유리하기 떄문이다.
        ...
        * */
        ...
        /* 정수가 담길 수 있는 공간인 int형으로 해놀으면 백만이 들어갔지만, 샐러리 = 급여 라는 것을 알 수 없고, 2만원이 보너스 값이라는 것을 이해할 수 없다. */
//        System.out.println("보너스를 포함한 급여 : " + (10000+2000) + "원");
